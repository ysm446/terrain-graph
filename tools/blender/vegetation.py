...
# --- 広葉樹の葉のカード -----------------------------------------------------------
# 小枝に付いた葉を描く画布（ダケカンバ / ミヤマハンノキ）。座標は画素（x 右、y 下）。
class LeafCanvas:
